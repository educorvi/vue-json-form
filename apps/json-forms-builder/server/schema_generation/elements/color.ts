...
type ColorElementOptionalKeys = keyof typeof colorElementDefaults | SimpleElementOptionalKeys;
export class ColorElement extends SimpleElement {
    ...
    constructor(
        data: Omit<PartialBy<ColorElementData, ColorElementOptionalKeys>, "type">
    ) {
        super(data);
    ...
    protected static setDefaults(data: PartialBy<ColorElementData, ColorElementOptionalKeys>): ColorElementData {
        return {
    ...
    static fromJsonSchemaAndUiSchema(id: string, jsonSchema: JSONSchema, uiSchema: any): ColorElement {
