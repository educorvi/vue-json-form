...
type DividerElementOptionalKeys = keyof typeof dividerElementDefaults | FormElementOptionalKeys;
export class DividerElement extends FormElement {
    ...
    constructor(
        data: Omit<PartialBy<DividerElementData, DividerElementOptionalKeys>, "type">
    ) {
        super(data);
        this.data = DividerElement.setDefaults(data);
    }

    protected static setDefaults(data: PartialBy<DividerElementData, DividerElementOptionalKeys>): DividerElementData {
        return {
    ...
    static fromJsonSchemaAndUiSchema(id: string, jsonSchema: JSONSchema={}, uiSchema: Divider): DividerElement {
