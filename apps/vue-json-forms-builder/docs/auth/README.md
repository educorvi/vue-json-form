...
A demo application exists within [apps/vue-json-forms-builder-external-example](../../vue-json-forms-builder-external-example) which goes into more detail on what needs to be configured and how the integration works. This uses a separate nuxt application and two local keycloak instances to showcase how they work together in a simple local demo application.
