...
export default defineNuxtConfig({
    ...
    runtimeConfig: {
        session: {
            cookie: {
                // Host-only cookie by default (localhost/dev/CI). Deployments
                // on a shared domain must set NUXT_COOKIE_DOMAIN (build-time)
                // or NUXT_SESSION_COOKIE_DOMAIN (runtime), e.g.
                // `.forms-test.educorvi.de` for staging.
                domain: process.env.NUXT_COOKIE_DOMAIN || undefined,
                path: '/',
                // Only mark the cookie Secure when explicitly enabled (e.g.
                // staging behind TLS). Plain-HTTP localhost/dev/CI must not.
    ...
    vite: {
        ...
        resolve: {
            alias: {
                ...
                'dayjs/plugin/duration': 'dayjs/plugin/duration.js',
                'dayjs/plugin/relativeTime': 'dayjs/plugin/relativeTime.js',
                // '@educorvi/vue-json-forms-builder': resolve(
                //     __dirname,
                //     '../../packages/vue-json-forms-builder/src/main.ts'
                // ),
                // '@educorvi/vue-json-forms-builder-schemas': resolve(
                //     __dirname,
                //     '../../packages/vue-json-forms-builder-schemas/schemas/index.ts'
                // ),
                // '@educorvi/vue-json-forms-builder-schemas/collab': resolve(
                //     __dirname,
                //     '../../packages/vue-json-forms-builder-schemas/schemas/collab/index.ts'
                // ),
            },
        },
    ...
    css: [
        ...
        '@educorvi/vue-json-forms-builder/dist/vue-json-form-builder.css',
    ],
