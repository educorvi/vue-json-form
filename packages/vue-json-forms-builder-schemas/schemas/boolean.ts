...
type BooleanElementOptionalKeys =
    keyof typeof booleanElementDefaults | SimpleElementOptionalKeys;
...
export class BooleanElement extends SimpleElement {
    ...
    constructor(
        data: Omit<
            PartialBy<BooleanElementData, BooleanElementOptionalKeys>,
            'type'
        >
    ) {
        super(data);
    ...
    protected static setDefaults(
        data: PartialBy<BooleanElementData, BooleanElementOptionalKeys>
    ): BooleanElementData {
        return {
