 ...
 * Get current user
 *
 * Returns the user row of the currently authenticated user
 *
 */
export const getUserMe = oc.route({
    description: 'Returns the user row of the currently authenticated user\n',
    inputStructure: 'detailed',
    method: 'GET',
