...
const basePrimitives: AuraBaseDesignTokens["primitive"] & Record<string, any> =
  {
    ...
    uvViolet: {
      50: "var(--uv-violet-10)",
      100: "var(--uv-violet-10)",
      200: "var(--uv-violet-20)",
      300: "var(--uv-violet-30)",
      400: "var(--uv-violet-30)",
      500: "var(--uv-violet-50)",
      600: "var(--uv-violet-60)",
      700: "var(--uv-violet-70)",
      800: "var(--uv-violet-70)",
      900: "var(--uv-violet-70)",
      950: "var(--uv-violet-70)",
    },
    uvRed: {
      50: "var(--uv-red-10)",
      100: "var(--uv-red-10)",
    ...
    uvOrange: {
      50: "var(--uv-orange-10)",
      100: "var(--uv-orange-10)",
      200: "var(--uv-orange-20)",
      300: "var(--uv-orange-30)",
      400: "var(--uv-orange-30)",
      500: "var(--uv-orange-50)",
      600: "var(--uv-orange-60)",
      700: "var(--uv-orange-70)",
      800: "var(--uv-orange-70)",
      900: "var(--uv-orange-70)",
      950: "var(--uv-orange-70)",
    },
    uvGrey: {
      0: "#ffffff",
      50: "var(--uv-grey-10)",
