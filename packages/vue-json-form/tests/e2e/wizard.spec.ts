...
test.describe('Wizard Page 1 - Personal Data', () => {
    ...
    test('Guardian agreement field is not visible for adults', async ({
        page,
    }) => {
        // Fill age as 18 or older
        await page
            .locator('input[name="/properties/personalData/properties/age"]')
            .fill('25');
    ...
    test('Can navigate to next page after filling required fields', async ({
        page,
    }) => {
...
test.describe('Wizard Page 2 - Message', () => {
    ...
    test('Important checkbox is visible with default value', async ({
        page,
    }) => {
        const importantCheckbox = page.locator(
            'input[name="/properties/message/properties/important"]'
        );
    ...
    test('Parents field is not visible for adults', async ({ page }) => {
        ...
        const parentsField = page.locator(
...
test.describe('Wizard Page 3 - Credentials', () => {
    ...
    test('Credentials field is visible', async ({ page }) => {
        const credentialsContainer = page.locator(
            '[name="/properties/credentials/properties/credentials"]'
        );
...
test.describe('Wizard Navigation Flow', () => {
    ...
    test('Form data persists when navigating between pages', async ({
        page,
    }) => {
        // Fill data on page 1
        await page
...
test.describe('Wizard Form Submission', () => {
    ...
    test('Submit form with complete adult data', async ({ page }) => {
        ...
        // Page 2 - Message
        await page
            .locator('input[name="/properties/message/properties/important"]')
            .uncheck();
        await page
            .locator(
                'textarea[name="/properties/message/properties/yourMessage"]'
            )
            .fill('This is my message');
        await page.getByRole('button', { name: 'Next' }).click();
...
test.describe('Wizard Conditional Fields', () => {
    ...
    test('Changing age from minor to adult hides guardian agreement', async ({
        page,
    }) => {
        // Set age as minor
        await page
    ...
    test('Changing age from adult to minor shows guardian agreement', async ({
        page,
    }) => {
        // Set age as adult
        await page
    ...
    test('Parents field appears and disappears based on age changes across pages', async ({
        page,
    }) => {
