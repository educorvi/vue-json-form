...
```bash
yarn workspace @educorvi/vue-json-form-builder-schemas build   # turbo: build:internal + check-types
yarn workspace @educorvi/vue-json-form-builder-schemas test:unit
```
